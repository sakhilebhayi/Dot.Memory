    ...
    <head>
        ...
        <style>
            ...
            input:focus, textarea:focus, select:focus {
                ...
                box-shadow: 0 0 0 3px rgba(242, 167, 11, 0.28) !important;
                outline: none !important;
            }
            .dark .dark\:bg-gray-200 { background-color: var(--amber) !important; }
            .dark .dark\:text-gray-800 { color: #12141a !important; }
            ...
            button:focus { box-shadow: 0 0 0 3px rgba(242, 167, 11, 0.35) !important; }
            ...
            input[type="checkbox"].dark\:bg-gray-900 { background-color: var(--ink) !important; border-color: rgba(238, 241, 245, 0.35) !important; }
